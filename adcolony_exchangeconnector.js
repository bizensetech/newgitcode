...
//var CampaignConfigMap = Agentconfig.Agentconfig;
...
function deleteId(id){                          // to delete the campaign 
...
router.post('/', function(req, res, next) {                 // http post request
    ...
    AudienceId.getAudienceId(bidrequest, val, function(val)     // userId 
    {   
...
// {"id":"132","price":0.2721,"crid":"169","impid":"1","ext":{"external-id":132,"priority":1,"bsexchange":"adcolony"}}
...
function sendResponse(res, bid){
    try{
        ...
        var cpInfo = campaignConfig.providerConfig["adcolony"];
        var crInfo = creativeConfig.providerConfig["adcolony"];
