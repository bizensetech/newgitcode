...
var CampaignConfigMap = {};      // object                    

//check if agentconfig is valid
function isCampaignValid(id, config){      
  //  if agentconfig is valid add it to CampaignConfigMap
...
//below relates to bidresponse 
//{"id": 132, "price":0.2721, "crid":169,"impid":1,"ext":{"external-id":132, "priority":1, "bsexchange":"mopub"}}
...
function sendResponse(res, bid){
    try{
        ...
        var cpInfo = campaignConfig.providerConfig["mopub"];                        // diff b/w campaignconfig and creativeconfig?
        var crInfo = creativeConfig.providerConfig["mopub"];
